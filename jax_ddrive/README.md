...
**Status (2026-06-08).** The full model is ported, parity-verified, and trains end-to-end:
...
- **Open:** the literal **≥8-chip multi-node TPU run** (blocked only by GCP trial capacity, external/transient); whole-model TP swap; JAX KV-cache fast decode.
