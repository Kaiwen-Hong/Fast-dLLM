...
- The released SFT/finetune scripts under `hackable_diffusion_adapter/` — need the un-vendored
  external `hackable_diffusion` library (not installed). This smoke uses a self-written CE loss instead.
