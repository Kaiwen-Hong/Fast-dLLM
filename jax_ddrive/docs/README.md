...
| [`6for_internal/0613-test_training.md`](6for_internal/0613-test_training.md) | **给内部 coding agent 的可执行 runbook**:从 GCS 拉 → 内部 TPU 从-base 训练 → B1 导出 → B2 推理(T2)→ 嵌入彩排 → 验证日志。含 GCS 实路径、精确命令、gotchas、tested-vs-pending。 |
