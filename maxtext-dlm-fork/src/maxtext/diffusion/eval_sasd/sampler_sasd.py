...
# ── VENDORED from Fast-dLLM ddrive_jax/eval/mm_sampler.py @ 4b0f4f2 — DO NOT EDIT logic here.
# Self-contained SASD inference for the internal-TPU fork (B2); only import lines rewritten
# (ddrive_jax.* -> local eval_sasd.*). Sync from source; see ../PATCHES.md / docs.
...
from .models.qwen2_5_text import mrope_cos_sin
from .masks_eval import eval_hybrid_block_causal_mask_dense, to_attn_mask4d
