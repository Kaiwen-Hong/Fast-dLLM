...
| 7.4 | Frozen-ViT image-embed injection + **full-VLA forward/loss parity vs NNX harness** | ✅ DONE & VERIFIED (rel 1.7e-4, 336 img-tok [订正 2026-06-16: 336 = 2N 的 doubled 计数;单份 = 168 = 3 cam × 56 @ train-res 784/50176 — 见 docs/0overview/02_gotchas.md#规范数字框-canonical-numbers]) |
