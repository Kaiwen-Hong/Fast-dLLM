...
def transformer_engine_context():
  ...
  try:
    ...
    # AssertionError: a transformer-engine pypi wheel whose native lib isn't actually
    # present raises during import (sanity_checks_for_pypi_installation). TE is optional,
    # so degrade gracefully to a no-op context on any unavailability.
    yield
